...
ALTER TABLE "diagnostic_answers" ADD CONSTRAINT "diagnostic_answers_question_id_diagnostic_questions_id_fk" FOREIGN KEY ("question_id") REFERENCES "public"."diagnostic_questions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "diagnostic_questions" ADD CONSTRAINT "diagnostic_questions_area_id_diagnostic_areas_id_fk" FOREIGN KEY ("area_id") REFERENCES "public"."diagnostic_areas"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "diagnostic_scores" ADD CONSTRAINT "diagnostic_scores_area_id_diagnostic_areas_id_fk" FOREIGN KEY ("area_id") REFERENCES "public"."diagnostic_areas"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "diagnostic_areas_slug_idx" ON "diagnostic_areas" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "diagnostic_areas_display_order_idx" ON "diagnostic_areas" USING btree ("display_order");--> statement-breakpoint
INSERT INTO "diagnostic_areas" ("name", "slug", "display_order", "is_default", "is_active") VALUES
	('Marketing', 'marketing', 1, true, true),
	('Comercial', 'comercial', 2, true, true),
	('Operacao', 'operacao', 3, true, true),
	('Financeiro', 'financeiro', 4, true, true),
	('Gestao', 'gestao', 5, true, true),
	('Atendimento', 'atendimento', 6, true, true),
	('Recursos Humanos', 'recursos-humanos', 7, true, true);--> statement-breakpoint
CREATE INDEX "diagnostic_questions_area_id_idx" ON "diagnostic_questions" USING btree ("area_id");--> statement-breakpoint
CREATE INDEX "diagnostic_questions_display_order_idx" ON "diagnostic_questions" USING btree ("display_order");--> statement-breakpoint
